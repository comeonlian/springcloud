...
public class PaymentController {
    ...
    private static HashMap<Long, Payment> hashMap = new HashMap() {{
        put(1L, new Payment(1L, "28a8c1e3bc2742d8848569891fb42181"));
        put(2L, new Payment(2L, "bba8c1e3bc2742d8848569891ac32182"));
        put(3L, new Payment(3L, "6ua8c1e3bc2742d8848569891xt92183"));
    }};
